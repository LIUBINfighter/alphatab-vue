...
.at-main g[data-name="repeat"] * {
  fill: #FFD54F !important; /* 反复记号改为暖黄色 */
...
.at-main .at-technique {
  fill: #80DEEA !important; /* 演奏技巧标记改为清新的浅蓝色/青色 */
}

/* 速度标记 */
.at-main g[data-name="tempo"] *,
.at-main .at-tempo {
  fill: #80DEEA !important; /* 速度标记改为清新的浅蓝色/青色 */
}
...
/* 工具栏背景 */
.at-controls {
  background-color: #1A2B42 !important; /* 工具栏背景使用略浅的深海军蓝 */
...
.at-controls .btn.active {
  background-color: #00ACC1 !important; /* 激活按钮背景使用清新的浅蓝色/青色深色调 */
}

/* 下拉菜单 */
.at-controls select {
  background-color: #1A2B42 !important; /* 下拉菜单背景与工具栏背景保持一致 */
  color: #FFFFFF !important;
}
`;
